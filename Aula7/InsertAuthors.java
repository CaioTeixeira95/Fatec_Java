...
public class InsertAuthors
{
   ...
   static final String DATABASE_URL = "jdbc:mysql://192.168.96.196:3306/books?useTimezone=true&serverTimezone=UTC";
   ...
   public static void main( String args[] )
   {
      ...
      try {
         connection = DriverManager.getConnection(DATABASE_URL, "root", "123mudar");
